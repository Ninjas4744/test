...
public class VisionIOPhoton implements VisionIO {
    ...
    public VisionIOPhoton(String name, Transform3d pose) {
        ...
        odometry = new PhotonPoseEstimator(
                Constants.FieldConstants.BLUE_FIELD_LAYOUT, PhotonPoseEstimator.PoseStrategy.MULTI_TAG_PNP_ON_COPROCESSOR, camera, pose);
    ...
    public void updateInputs(VisionIOInputs inputs) {
        ...
        odometry.setFieldTags(Constants.FieldConstants.getFieldLayout());
    }
